...
export const heroData = [
    {id:1, name: "Ice Cream", desc: "Choclate & Vanilla", price: "5.25", imageSrc: I1},
    {id:2, name: "Strawberries", desc: "Fresh Strawberries", price: "10.25", imageSrc: F1},
    {id:3, name: "Chicken Kabab", desc: "Mixed Kebab Plate", price: "8.15", imageSrc: C3},
...
export const categories = [
    ...
    {id: 7, name: "Deserts", urlParamName: "deserts"},
    {id: 8, name: "Soft Drinks", urlParamName: "drinks"},
]