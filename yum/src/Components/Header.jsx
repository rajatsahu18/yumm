          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                ...
                <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 translate-all duration-100 ease-in-out text-textColor text-base" onClick={logout}>
                  Logout <MdLogout />
                </p>
              </motion.div>
            )}
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              gap-3 justify-center bg-gray-200 cursor-pointer hover:bg-gray-300 translate-all 
