    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:px-16 bg-primary">
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <p className="text-headingColor text-xl font-bold">Yumm</p>
        </Link>
        <div className="flex items-center gap-8">
          ...
          <div className="relative flex items-center justify-center" onClick={showCart}>
            ...
            {cartItems && cartItems.length > 0 && (
              <div
              className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartNumBg flex 
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "sahurajat78@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 translate-all duration-100 ease-in-out text-textColor text-base" onClick={() => setIsMenu(false)}>
                      New Item <MdAdd />
                    </p>
                  </Link>
                )}
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              gap-3 justify-center bg-gray-200 cursor-pointer hover:bg-gray-300 transition-all 
